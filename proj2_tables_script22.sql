drop trigger g_enrollments_trigger_insert;
drop trigger g_enrollments_trigger_delete;
drop trigger student_trigger_delete;
drop trigger logs_delete_student;
drop trigger logs_insert_enrollments;
drop trigger logs_delete_enrollments;
...
start proj2_sequence;
start proj2_triggers;
start proj2_procedures;
